    ...
    $elements = [
        ...
        [
            ...
            'answer' => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        ...
                        <p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href='country-association-form' target='_blank'>Contattaci</a> se ritieni che il paese associato al tuo account sia sbagliato.</p>"
        ],
        [
            ...
            <ul>
                <?php
                    for ($i=0; $i < count($menuElements); $i++) { 
                        echo '<li class="menuLi"><a class="menuIndex" href="#">' . $menuElements[$i] . '</a></li>';
                    }
                ?>
